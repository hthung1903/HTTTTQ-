...
namespace QuanLyDeTai.TieuDoan.ThongKe
{
    public partial class THONGKE : Form
    {
        ...
        private void getBB()
        {
            string query = "TieuDoan_detaikhenthuong '"+MaDT+"'";
            DataTable dt = ConnectDB.Connected.getData(query);
        ...
        private void cmbLocBB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string query = "TieuDoan_detaikhenthuong_capdo '"+MaDT+"',N'" + cmbLocCDKT.SelectedItem.ToString() + "'";
